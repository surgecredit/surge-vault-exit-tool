  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white flex flex-col">
      ...
      <footer className="border-t border-gray-800 bg-gray-950">
        <div className="mx-auto flex max-w-3xl items-center justify-between px-4 py-8">
          <div className="flex items-center gap-4 text-sm text-gray-200">
            <div className="flex items-center gap-3">
              <div className="grid h-6 w-6 grid-cols-2 gap-0.5 rounded-sm">
                <span className="bg-orange-500" />
                <span className="bg-transparent" />
                <span className="bg-orange-500" />
                <span className="bg-orange-500" />
              </div>
              <span className="font-semibold">Surge Protocol</span>
            </div>
          </div>
